...
describe('.set()/.get()', function () {
  ...
  describe('with invalid arguments', function () {
    ...
    it('should error when called with invalid option', function() {
      ...
      }.bind(this)).to.throw('Invalid configuration settings. "' +
    ...
    it('should error when "methods" not string/array of strings', function() {
      var key = 'methods';
    ...
    it('should error when "payload" not string/object', function() {
      var key = 'payload';
