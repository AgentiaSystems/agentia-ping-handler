...
describe('.config()', function () {
	...
	describe('with valid arguments', function () {
		...
		it('should call .set() for every option passed', function () {
			...
			expect(this.handler.set).to.have.been.calledWithExactly('path', '/valid/path');
			this.handler.set.reset();
			...
			expect(this.handler.set.firstCall).to.have.been.calledWithExactly('path', '/valid/path');
			expect(this.handler.set.secondCall).to.have.been.calledWithExactly('methods', ['GET', 'HEAD']);
			expect(this.handler.set.thirdCall).to.have.been.calledWithExactly('payload', 'GOOD');
		});
